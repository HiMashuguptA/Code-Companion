...
export const listProductTags = async (
  options?: RequestInit,
): Promise<ListProductTags200Item[]> => {
  return customFetch<ListProductTags200Item[]>(getListProductTagsUrl(), {
    ...options,
    method: "GET",
  });
};
 ...
 */
export const getListMyCoinTransactionsUrl = () => {
  return `/api/referrals/transactions`;
};

export const listMyCoinTransactions = async (
  options?: RequestInit,
): Promise<CoinTransaction[]> => {
  return customFetch<CoinTransaction[]>(getListMyCoinTransactionsUrl(), {
    ...options,
    method: "GET",
  });
};

export const getListMyCoinTransactionsQueryKey = () => {
  return [`/api/referrals/transactions`] as const;
};

export const getListMyCoinTransactionsQueryOptions = <
  TData = Awaited<ReturnType<typeof listMyCoinTransactions>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof listMyCoinTransactions>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getListMyCoinTransactionsQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listMyCoinTransactions>>
  > = ({ signal }) => listMyCoinTransactions({ signal, ...requestOptions });
...
export type ListMyCoinTransactionsQueryResult = NonNullable<
  Awaited<ReturnType<typeof listMyCoinTransactions>>
>;
export type ListMyCoinTransactionsQueryError = ErrorType<unknown>;

/**
 * @summary List the current user's Super Coin transactions
 */

export function useListMyCoinTransactions<
  TData = Awaited<ReturnType<typeof listMyCoinTransactions>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryOptions = getListMyCoinTransactionsQueryOptions(options);
 ...
 */
export const getGetSalesRangeUrl = (params: GetSalesRangeParams) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0
    ? `/api/analytics/sales-range?${stringifiedParams}`
    : `/api/analytics/sales-range`;
};

export const getSalesRange = async (
  params: GetSalesRangeParams,
  options?: RequestInit,
): Promise<RevenueDataPoint[]> => {
  return customFetch<RevenueDataPoint[]>(getGetSalesRangeUrl(params), {
    ...options,
    method: "GET",
  });
};

export const getGetSalesRangeQueryKey = (params?: GetSalesRangeParams) => {
  return [`/api/analytics/sales-range`, ...(params ? [params] : [])] as const;
};

export const getGetSalesRangeQueryOptions = <
  TData = Awaited<ReturnType<typeof getSalesRange>>,
  TError = ErrorType<unknown>,
>(
  params: GetSalesRangeParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getSalesRange>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetSalesRangeQueryKey(params);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getSalesRange>>> = ({
    signal,
  }) => getSalesRange(params, { signal, ...requestOptions });
...
export type GetSalesRangeQueryResult = NonNullable<
  Awaited<ReturnType<typeof getSalesRange>>
>;
export type GetSalesRangeQueryError = ErrorType<unknown>;

/**
 * @summary Get day-wise sales for an arbitrary date range (Admin)
 */

export function useGetSalesRange<
  TData = Awaited<ReturnType<typeof getSalesRange>>,
  TError = ErrorType<unknown>,
>(
  params: GetSalesRangeParams,
  ...
  const queryOptions = getGetSalesRangeQueryOptions(params, options);
...
export const getInventoryInsights = async (
  ...
  return customFetch<InventoryInsights>(getGetInventoryInsightsUrl(), {
    ...options,
    method: "GET",
  });
};
