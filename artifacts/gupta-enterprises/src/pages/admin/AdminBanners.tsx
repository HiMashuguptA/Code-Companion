...
import { Plus, Pencil, Trash2, Eye, EyeOff, ImageIcon, ExternalLink } from "lucide-react";
...
interface BannerRecord extends BannerForm {
  id: string;
}
...
export function AdminBanners() {
  ...
  function handleToggleActive(b: BannerRecord) {
    updateMut.mutate(
      { bannerId: b.id, data: { isActive: !b.isActive } },
      {
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Promotional banners on the homepage. Place them at the top, middle, or bottom.</p>
        </div>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>Promotional banners shown on the homepage.</DialogDescription>
          </DialogHeader>
          <div className="grid gap-3">
            <div>
            ...
            <div>
              ...
              <Input id="b-link" value={form.linkUrl} onChange={(e) => setForm((f) => ({ ...f, linkUrl: e.target.value }))} placeholder="/products?category=pens-pencils" />
            </div>
